...
class SaveBooking extends React.Component {
  ...
  handleChange = (e) => {
    ...
    if ((nm == "destfrom") | (nm == "destto")) {
      ...
      this.setState({
        [nm2]: JSON.parse(localStorage.getItem("Bookedvehicle")).vid,
      });
      ...
      <div class="container-fluid my-3">
        <div class="row justify-content-around">
          <div class="col-md-12 bg-light shadow px-4 pt-4">
            <h4 class="display-4">
              <i class="fa fa-asterisk" aria-hidden="true"></i> Enter Booking
              Details{" "}
            </h4>
            ...
            <Form>
              ...
              <br />
              <FormGroup row>
                <Label for="exampleDestfrom" sm={10}>
                  Enter Ending point :{" "}
                </Label>
                <Col sm={10}>
                  <Input
              ...
              <FormGroup check row>
                <Col sm={{ size: 10, offset: 2 }}>
                  ...
                  &nbsp;
                  <Button type="reset" class="btn btn-danger" color="danger">
                    Reset
                  </Button>
                  <ToastContainer
                    position="top-center"
